export default {
  ...
  colors: {
    ...
    primary: '#0c5c99', // primary button and link color
    secondary: '#0a4e82', // secondary color - can be used for hover states
    muted: '#7B8188', // muted color
    accent: '#0a4e82', // a contrast color for emphasizing UI
    dark: '#10132D',
    link: '#3183FF',
