export default {
  ...
  colors: {
    ...
    primary: '#3f8299', // primary button and link color
    secondary: '#0f4c68', // secondary color - can be used for hover states
    muted: '#7B8188', // muted color
    accent: '#0f4c68', // a contrast color for emphasizing UI
    dark: '#10132D',
    link: '#3183FF',
